...
Система ACT-RENTAL использует комплексный набор тестов, включающий модульные (unit) тесты, интеграционные тесты и сквозные тесты. Тесты написаны с использованием pytest и pytest-asyncio для поддержки асинхронного тестирования.
...
#### Тесты API клиентов (`test_clients_api.py`)
- Создание клиента
- Обработка дублирования email и телефона
