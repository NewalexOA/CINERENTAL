 ...
 */
export const ADD_EQUIPMENT_CONFIG = {
    type: 'equipment_add',
 ...
 */
export const RETURN_EQUIPMENT_CONFIG = {
 ...
 */
export const TRANSFER_EQUIPMENT_CONFIG = {
 ...
 */
export function createCartConfig(type, overrides = {}) {
    let baseConfig;
 ...
 */
export function validateCartConfig(config) {
 ...
 */
export function getAllCartConfigs() {
    return {
