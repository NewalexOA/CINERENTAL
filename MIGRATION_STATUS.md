...
- **Завершить и протестировать страницу создания проекта (`NewProjectPage.tsx`)**: Убедиться в корректной обработке всех сценариев, включая ошибки при проверке доступности оборудования.
- **Реализовать страницу просмотра существующего проекта (`ProjectDetailsPage.tsx`)**: Сфокусироваться на загрузке и отображении основной информации о проекте и полного списка забронированного оборудования с их индивидуальными датами.
- **Добавить функционал редактирования проекта**: В первую очередь — реализовать возможность добавления нового оборудования в уже существующий проект, переиспользуя компонент `EquipmentPicker`.
- **Реализовать изменение статусов бронирований и логику печати документов**: Восстановить функционал, аналогичный старому шаблону `projects/view.html`.
